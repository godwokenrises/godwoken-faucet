  ...
  return (
    <>
      ...
      <main>
        ...
        <div className="flex flex-col justify-center items-center bg-green-950 w-full sm:min-h-[50vh]">
          ...
          <div className="mb-16">
            <span className="text-white">
              There are{" "}
              {balanceData ? formatValue(balanceData.balance) : "-.--"} <a href="https://docs.godwoken.io/pCKB">pCKB </a>
                ...
                <div className="relative " key={tx.transactionHash}>
                  ...
                  <div className="flex flex-col p-8 mb-8 bg-white border border-gray-400 z-30">
                    ...
                    <div className="flex flex-col sm:flex-row justify-between pt-2">
                      ...
                      <span>
                        {weiToEth(BigInt(tx.value.toString()))} <a href="https://docs.godwoken.io/pCKB">pCKB</a>
                      </span>
                    </div>
                    <div className="mt-4">
                      <Badge
