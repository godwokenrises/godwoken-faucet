...
export async function binancePrices(allSymbols: Set<string>): Promise<PriceInfos> {
...
export function getBinancePrice(coinSymbol: string, infos: BinancePriceInfo): string | undefined {
